...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      ...
      cy.get(`[data-cy="pin"]`).type('22161').should('have.value', '22161');

      cy.get(`[data-cy="email"]`).type('Benny_Kovacek16@yahoo.com').should('have.value', 'Benny_Kovacek16@yahoo.com');

      cy.get(`[data-cy="phone"]`).type('39851').should('have.value', '39851');
