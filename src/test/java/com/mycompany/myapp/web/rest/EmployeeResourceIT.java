...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().name(DEFAULT_NAME).pin(DEFAULT_PIN).email(DEFAULT_EMAIL).phone(DEFAULT_PHONE);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().name(UPDATED_NAME).pin(UPDATED_PIN).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
        return employee;
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.name(UPDATED_NAME).pin(UPDATED_PIN).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.pin(UPDATED_PIN).email(UPDATED_EMAIL);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.name(UPDATED_NAME).pin(UPDATED_PIN).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
